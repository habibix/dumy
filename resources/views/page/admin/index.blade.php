        ...
        <form action="{{ route('addCamera') }}" method="post">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="" name="area_capture" class="form-control" placeholder="Area Capture, example [x, x], [x, x], [x, x], [x, x]" required>
            </div>

            <div class="form-group">
              <label for="">Camera Meta - Area Khusus</label>
              <input type="" name="area_khusus" class="form-control" placeholder="Area Khusus, example [x, x], [x, x], [x, x], [x, x]" required>
            </div>
