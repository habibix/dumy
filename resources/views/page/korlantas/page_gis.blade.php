...
<!-- CONTENT -->
@section('content')
<section class="content" style="background: #fff; padding: 10px; color: #000">
...
<script src="{{ asset('../../sdk/form.js') }}" type="text/javascript"></script>
<script type='text/javascript' src='https://cdn.rawgit.com/jasonmoo/t.js/master/t.min.js'></script>
<script src="{{ asset('../../sdk/tomtom.min.js') }}" type="text/javascript"></script>
